...
git clone https://github.com/sirpdboy/luci-app-watchdog package/myapp/luci-app-watchdog
git clone https://github.com/sirpdboy/luci-app-eqosplus package/myapp/luci-app-eqosplus
